...
class appAppKernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0u2lM7d9mW', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3cQI5lC4Px', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/modules/psxdesign/src/Entity')]);
        $d->addExcludePaths([0 => (\dirname(__DIR__, 4).'/modules/psxdesign/src/Entity/index.php')]);
        ...
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/modules/productcomments/src/Entity')]);
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/modules/ps_accounts/src/Entity')]), 'PrestaShop\\Module\\PsAccounts\\Entity');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('8.1.5', '%s?%s'), new \Symfony\Component\Asset\Context\RequestStackContext($d, '', false)), [])));
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q8ZvEBOsoL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bbMo6GA7-R', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1vAymWv6RQ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZGWsxm0Tej', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wdFQeZv7xv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AnHX+MuLO+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XWweWo+kh6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yTN8joHzuJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('F27v4nH7HK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IPpbYR4i7b', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ndNXr5vOpU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'modules_translation_paths' => [
                ...
                32 => (\dirname(__DIR__, 4).'/modules/ps_googleanalytics/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/psxdesign/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/ps_accounts/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/ps_mbo/translations'),
                38 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                39 => (\dirname(__DIR__, 4).'/modules/ps_checkout/translations'),
                40 => (\dirname(__DIR__, 4).'/modules/statsnewsletter/translations'),
                41 => (\dirname(__DIR__, 4).'/modules/statssales/translations'),
                42 => (\dirname(__DIR__, 4).'/modules/ps_faviconnotificationbo/translations'),
                43 => (\dirname(__DIR__, 4).'/modules/ps_brandlist/translations'),
                44 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                45 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                46 => (\dirname(__DIR__, 4).'/modules/statsbestproducts/translations'),
                47 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
                48 => (\dirname(__DIR__, 4).'/modules/psassistant/translations'),
                49 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                50 => (\dirname(__DIR__, 4).'/modules/mbeshipping/translations'),
                51 => (\dirname(__DIR__, 4).'/modules/ps_edition_basic/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/psxmarketingwithgoogle/translations'),
                53 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/ps_supplierlist/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/statssearch/translations'),
                58 => (\dirname(__DIR__, 4).'/modules/ps_wirepayment/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                60 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/ps_metrics/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/gamification/translations'),
                66 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                67 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
                68 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                69 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
            ],
