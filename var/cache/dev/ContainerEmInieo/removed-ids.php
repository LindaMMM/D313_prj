...
return [
    '.1_DoctrineProvider~pQLGx3N' => true,
    '.1_LegacyRouteLoaderContainer~olgqwN3' => true,
    '.1_NativeFileSessionHandler~MjZmr4s' => true,
    '.1_NonceGenerator~SqPBSwN' => true,
    '.1_ResolvedFormTypeFactory~VDlWaZX' => true,
    '.1_Serializer~clHFUFD' => true,
    '.1_ServiceLocator~1suKe.W' => true,
    '.1_SourceContextProvider~C9VoRPI' => true,
    '.1_Swift_Transport_Esmtp_Auth_CramMd5Authenticator~hZhR5cm' => true,
    '.1_bool~glzGQZH' => true,
    '.1_~GgiBh4r' => true,
    '.1_~vUJxDbk' => true,
    '.2_ArrayAdapter~pQLGx3N' => true,
    '.2_HtmlDumper~SqPBSwN' => true,
    '.2_ObjectNormalizer~clHFUFD' => true,
    '.2_SourceContextProvider~C9VoRPI' => true,
    '.2_Swift_Transport_Esmtp_Auth_LoginAuthenticator~hZhR5cm' => true,
    '.2_~GgiBh4r' => true,
    '.2_~vUJxDbk' => true,
    '.3_RequestContextProvider~C9VoRPI' => true,
    '.3_Swift_Transport_Esmtp_Auth_PlainAuthenticator~hZhR5cm' => true,
    '.4_CliContextProvider~C9VoRPI' => true,
    '.4_Swift_Transport_Esmtp_Auth_NTLMAuthenticator~hZhR5cm' => true,
    '.5_CliDescriptor~C9VoRPI' => true,
    '.6_HtmlDescriptor~C9VoRPI' => true,
