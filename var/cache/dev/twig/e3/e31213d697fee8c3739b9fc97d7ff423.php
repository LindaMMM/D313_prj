...
class __TwigTemplate_94b5f10f8bb5d91520144bb23bba57d5 extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 35, $this->source); })()), "request", [], "any", false, false, false, 35), "query", [], "any", false, false, false, 35), "get", [0 => "id_cms_category"], "method", false, false, false, 35)]), "desc" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Add new page", [], "Admin.Design.Help"), "icon" => "add_circle_outline"]];
  ...
  ";
    ...
    public function block_cms_category_grid($context, array $blocks = [])
    {
        ...
        // line 51
        echo "    ";
        $this->loadTemplate("@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", 51, "1861223459")->display(twig_array_merge($context, ["grid" => (isset($context["cmsCategoryGrid"]) || array_key_exists("cmsCategoryGrid", $context) ? $context["cmsCategoryGrid"] : (function () { throw new RuntimeError('Variable "cmsCategoryGrid" does not exist.', 51, $this->source); })())]));
        // line 58
        echo "  ";
...
{% endblock %}
", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "/home/linda/Projets/d313/src/PrestaShopBundle/Resources/views/Admin/Improve/Design/Cms/index.html.twig");
    }
}


/* @PrestaShop/Admin/Improve/Design/Cms/index.html.twig */
class __TwigTemplate_94b5f10f8bb5d91520144bb23bba57d5___1861223459 extends Template
{
    private $source;
    private $macros = [];
